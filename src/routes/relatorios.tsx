  ...
  return (
    <AppLayout title="Relatórios">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {REPORTS.map((r) => (
          <div key={r.title} className="bg-surface-container border border-border-low p-6 flex gap-4 items-start hover:border-primary-container/50 transition-colors">
            ...
            <div className="flex-1">
              ...
              <button className="mt-3 text-sm font-semibold text-primary-container hover:underline">Gerar relatório →</button>
            </div>
          </div>
        ))}
      </div>
